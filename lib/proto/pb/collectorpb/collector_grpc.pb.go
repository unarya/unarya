...
const (
	CollectorService_Ready_FullMethodName              = "/collectorpb.CollectorService/Ready"
	...
	CollectorService_RemoveDir_FullMethodName          = "/collectorpb.CollectorService/RemoveDir"
)

// CollectorServiceClient is the client API for CollectorService services.
//
...
type CollectorServiceClient interface {
	...
	Ready(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ServiceReadyResponse, error)
	...
	// Remove Directory
	RemoveDir(ctx context.Context, in *Path, opts ...grpc.CallOption) (*ServiceOKResponse, error)
}
...
func (c *collectorServiceClient) Ready(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ServiceReadyResponse, error) {
...
func (c *collectorServiceClient) RemoveDir(ctx context.Context, in *Path, opts ...grpc.CallOption) (*ServiceOKResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ServiceOKResponse)
	err := c.cc.Invoke(ctx, CollectorService_RemoveDir_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// CollectorServiceServer is the server API for CollectorService services.
...
type CollectorServiceServer interface {
	// Checking services ready
	Ready(context.Context, *Empty) (*ServiceReadyResponse, error)
	// Clone repository from Git (GitHub, GitLab, Bitbucket)
	...
	// Remove Directory
	RemoveDir(context.Context, *Path) (*ServiceOKResponse, error)
...
func (UnimplementedCollectorServiceServer) Ready(context.Context, *Empty) (*ServiceReadyResponse, error) {
...
func (UnimplementedCollectorServiceServer) CollectFromGit(context.Context, *GitRequest) (*CollectorResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CollectFromGit not implemented")
}
func (UnimplementedCollectorServiceServer) CollectFromArchive(context.Context, *ArchiveRequest) (*CollectorResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CollectFromArchive not implemented")
}
func (UnimplementedCollectorServiceServer) CollectFromURL(context.Context, *URLRequest) (*CollectorResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CollectFromURL not implemented")
}
func (UnimplementedCollectorServiceServer) ValidateSource(context.Context, *ValidateRequest) (*ValidateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ValidateSource not implemented")
}
func (UnimplementedCollectorServiceServer) RemoveDir(context.Context, *Path) (*ServiceOKResponse, error) {
...
// UnsafeCollectorServiceServer may be embedded to opt out of forward compatibility for this services.
...
func _CollectorService_Ready_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CollectorServiceServer).Ready(ctx, req.(*Empty))
	}
...
func _CollectorService_RemoveDir_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Path)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CollectorServiceServer).RemoveDir(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CollectorService_RemoveDir_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CollectorServiceServer).RemoveDir(ctx, req.(*Path))
	}
	return interceptor(ctx, in, info, handler)
}

// CollectorService_ServiceDesc is the grpc.ServiceDesc for CollectorService services.
...
var CollectorService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CollectorService_RemoveDir_Handler,
		},
	},
