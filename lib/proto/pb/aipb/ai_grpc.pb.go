...
// AIInferenceClient is the client API for AIInference services.
//
...
// AIInferenceServer is the server API for AIInference services.
...
// UnsafeAIInferenceServer may be embedded to opt out of forward compatibility for this services.
...
func RegisterAIInferenceServer(s grpc.ServiceRegistrar, srv AIInferenceServer) {
	// If the following call panics, it indicates UnimplementedAIInferenceServer was
...
// AIInference_ServiceDesc is the grpc.ServiceDesc for AIInference services.
...
// AIServiceClient is the client API for AIService services.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
//
// ============================================================
...
// AIServiceServer is the server API for AIService services.
...
// UnsafeAIServiceServer may be embedded to opt out of forward compatibility for this services.
...
// AIService_ServiceDesc is the grpc.ServiceDesc for AIService services.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
